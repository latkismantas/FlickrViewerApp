...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int photoPos = intent.getIntExtra("PHOTO_POSITION", 0);
        ImageInfo photo = NetworkMgr.getInstance(this).imageList.get(photoPos);
    ...
    private ImageLoader.ImageListener imageListener = new ImageLoader.ImageListener() {
        ...
        public void onResponse(ImageLoader.ImageContainer response, boolean isImmediate) {
            if (response.getBitmap() != null)
                mContentView.setImageBitmap (response.getBitmap());
        }
